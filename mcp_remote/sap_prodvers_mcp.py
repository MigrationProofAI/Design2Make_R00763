...
def create_production_version(
    ...
    bom_usage: Annotated[str, Field(description="BOM usage STLAN, e.g. '1'; blank = let SAP resolve")] = "",
    bom_alt: Annotated[str, Field(description="BOM alternative STLAL, e.g. '01'; blank = let SAP resolve")] = "",
